...
// Only allow http(s) links through to rendering — a feed source could serve a
// malformed/malicious <link> (e.g. a `javascript:` scheme) that would render
// as a normal clickable <a href> in pages/aktuelt.js.
...
export function parseFeed(xml, limit = 6) {
  ...
  for (const block of blocks) {
    ...
    items.push({ title, link: safeLink(link), date, summary });
