...
import { REPORT_CATEGORY_ICON_IMAGE_EXPRESSION } from './reportCategoryIcons';
...
export const MAP_STYLE = {
  ...
  reportCategorySymbolLayout: {
    'icon-image': REPORT_CATEGORY_ICON_IMAGE_EXPRESSION,
    'icon-size': ['interpolate', ['linear'], ['zoom'], 10, 0.5, 14, 0.72, 17, 0.95],
