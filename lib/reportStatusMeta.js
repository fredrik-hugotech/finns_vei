...
export const REPORT_STATUS_META = {
  ...
  // Label "Avsluttet" (ikke "Fullført") siden 2026-08-26: statusen betyr at
  // VÅR saksbehandling er ferdig, ikke at det utrygge stedet faktisk er
  // utbedret — det kan vi ikke love. Nøkkelen ('fullfort'), CSS-klassen og
  // den lagrede statusverdien (REPORT_STATUS.DONE = 'Fullført', Trello-
  // kolonnenavnet) er uendret — kun visningsteksten er ny.
  [REPORT_STATUS.DONE]: { key: 'fullfort', label: 'Avsluttet', marker: '#16A34A', tint: '#DCFCE7', text: '#15803D', icon: STATUS_ICON.fullfort },
};
