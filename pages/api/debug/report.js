...
// Secret-gated, but each call reads Supabase - rate limit it like the other
// secret-gated endpoints so a leaked/guessed DEBUG_SECRET can't be used to
// hammer NVDB/Trello.
const RATE_LIMIT = 10;
...
export default async function handler(req, res) {
  ...
  const rateLimit = checkRequestRateLimit(req, 'debug-report', RATE_LIMIT, RATE_LIMIT_WINDOW_MS);
