...
// Requires an already-valid session cookie, but this still verifies a
// password on every call - rate limit it for consistency with the other
// credential endpoint (staff/login.js).
const RATE_LIMIT = 10;
